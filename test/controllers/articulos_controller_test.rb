...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { descripcion: @articulo.descripcion, titulo: @articulo.titulo, user_id: @articulo.user_id } }, as: :json
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { descripcion: @articulo.descripcion, titulo: @articulo.titulo, user_id: @articulo.user_id } }, as: :json
    assert_response 200
  end
